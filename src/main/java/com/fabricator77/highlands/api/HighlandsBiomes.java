package com.fabricator77.highlands.api;
...
public class HighlandsBiomes {
    ...
    /**
     * Adds a creature to spawn in a certain biome. Not compatible with
     * DrZhark's CustomMobSpawner.
     *
     * @param biome the biome to add the creature to. Only works with these
     * biomes, not vanilla or other mods' biomes.
