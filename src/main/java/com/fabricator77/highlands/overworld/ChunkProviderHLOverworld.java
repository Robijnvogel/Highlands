package com.fabricator77.highlands.overworld;

import com.fabricator77.highlands.Initializer;
...
public class ChunkProviderHLOverworld implements IChunkProvider, IMWChunkProvider {
    ...
    public ChunkProviderHLOverworld(World par1World, long par2, boolean par4) {
        ...
        if (genStronghold(this.worldObj.provider.dimensionId)) {
            strongholdGenerator = (MapGenStronghold) TerrainGen.getModdedMapGen(strongholdGenerator, STRONGHOLD);
        }
        if (genVillages(this.worldObj.provider.dimensionId)) {
            villageGenerator = (MapGenVillage) TerrainGen.getModdedMapGen(villageGenerator, VILLAGE);
        }
        if (genMineshaft(this.worldObj.provider.dimensionId)) {
            mineshaftGenerator = (MapGenMineshaft) TerrainGen.getModdedMapGen(mineshaftGenerator, MINESHAFT);
        }
        if (genScatteredFeature(this.worldObj.provider.dimensionId)) {
    ...
    public Chunk provideChunk(int par1, int par2) {
        ...
        this.ravineGenerator.generate(this, this.worldObj, par1, par2, ablock);

        if (this.mapFeaturesEnabled) {
            if (genMineshaft(this.worldObj.provider.dimensionId)) {
                this.mineshaftGenerator.generate(this, this.worldObj, par1, par2, ablock);
            }
            if (genVillages(this.worldObj.provider.dimensionId)) {
                this.villageGenerator.generate(this, this.worldObj, par1, par2, ablock);
            }
            if (genStronghold(this.worldObj.provider.dimensionId)) {
                this.strongholdGenerator.generate(this, this.worldObj, par1, par2, ablock);
            }
            if (genScatteredFeature(this.worldObj.provider.dimensionId)) {
                this.scatteredFeatureGenerator.generate(this, this.worldObj, par1, par2, ablock);
            }
        }
    ...
    public void recreateStructures(int par1, int par2) {
        if (this.mapFeaturesEnabled) {
            if (genMineshaft(this.worldObj.provider.dimensionId)) {
                this.mineshaftGenerator.generate(this, this.worldObj, par1, par2, (Block[]) null);
            }
            if (genVillages(this.worldObj.provider.dimensionId)) {
                this.villageGenerator.generate(this, this.worldObj, par1, par2, (Block[]) null);
            }
            if (genStronghold(this.worldObj.provider.dimensionId)) {
                this.strongholdGenerator.generate(this, this.worldObj, par1, par2, (Block[]) null);
            }
            if (genScatteredFeature(this.worldObj.provider.dimensionId)) {
                this.scatteredFeatureGenerator.generate(this, this.worldObj, par1, par2, (Block[]) null);
            }
        }
    }
    ...
    public boolean genVillages(int dim) {
        if (Initializer.tooManyBiomesInstalled) {
            return false;
        } else {
            return true;
        }
