...
import com.fabricator77.highlands.block.BlockHighlandsLeaves;
import com.fabricator77.highlands.block.BlockHighlandsSapling2;
import com.fabricator77.highlands.block.BlockHighlandsSmallPlants;
import com.fabricator77.highlands.block.BlockCocoaPlant2;
import com.fabricator77.highlands.block.BlockHighlandsPlanks;
import com.fabricator77.highlands.block.BlockHighlandsLeaves2;
import com.fabricator77.highlands.block.ItemBlockMetadata;
import com.fabricator77.highlands.block.BlockHLPlankSlab;
import com.fabricator77.highlands.block.BlockHighlandsSapling;
import com.fabricator77.highlands.block.ItemSlabPlanks;
import com.fabricator77.highlands.block.BlockHighlandsLog;
import com.fabricator77.highlands.block.ItemHighlandsBerries;
import com.fabricator77.highlands.block.BlockHighlandsLog2;
import com.fabricator77.highlands.block.ItemBlockPlanks;
import com.fabricator77.highlands.block.BlockHighlandsStairs;
import com.fabricator77.highlands.api.HighlandsBiomes;
import com.fabricator77.highlands.api.HighlandsBlocks;
import com.fabricator77.highlands.biome.BiomeGenAlps;
import com.fabricator77.highlands.biome.BiomeGenAutumnForest;
import com.fabricator77.highlands.biome.BiomeGenBadlands;
import com.fabricator77.highlands.biome.BiomeGenBaldHill;
import com.fabricator77.highlands.biome.BiomeGenBaseHighlands;
import com.fabricator77.highlands.biome.BiomeGenBirchHills;
import com.fabricator77.highlands.biome.BiomeGenBog;
import com.fabricator77.highlands.biome.BiomeGenCliffs;
import com.fabricator77.highlands.biome.BiomeGenDesertIsland;
import com.fabricator77.highlands.biome.BiomeGenDesertMountains;
import com.fabricator77.highlands.biome.BiomeGenDunes;
import com.fabricator77.highlands.biome.BiomeGenEstuary;
import com.fabricator77.highlands.biome.BiomeGenFlyingMountains;
import com.fabricator77.highlands.biome.BiomeGenGlacier;
import com.fabricator77.highlands.biome.BiomeGenHighlands;
import com.fabricator77.highlands.biome.BiomeGenLake;
import com.fabricator77.highlands.biome.BiomeGenLowlands;
import com.fabricator77.highlands.biome.BiomeGenMeadow;
import com.fabricator77.highlands.biome.BiomeGenMesa;
import com.fabricator77.highlands.biome.BiomeGenOasis;
import com.fabricator77.highlands.biome.BiomeGenOcean2;
import com.fabricator77.highlands.biome.BiomeGenOutback;
import com.fabricator77.highlands.biome.BiomeGenPinelands;
import com.fabricator77.highlands.biome.BiomeGenRainforest;
import com.fabricator77.highlands.biome.BiomeGenRedwoodForest;
import com.fabricator77.highlands.biome.BiomeGenRockIsland;
import com.fabricator77.highlands.biome.BiomeGenRockMountains;
import com.fabricator77.highlands.biome.BiomeGenSahel;
import com.fabricator77.highlands.biome.BiomeGenSavannah;
import com.fabricator77.highlands.biome.BiomeGenShrubland;
import com.fabricator77.highlands.biome.BiomeGenSnowMountains;
import com.fabricator77.highlands.biome.BiomeGenSteppe;
import com.fabricator77.highlands.biome.BiomeGenTallPineForest;
import com.fabricator77.highlands.biome.BiomeGenTropicalIslands;
import com.fabricator77.highlands.biome.BiomeGenTropics;
import com.fabricator77.highlands.biome.BiomeGenTundra;
import com.fabricator77.highlands.biome.BiomeGenVolcanoIsland;
import com.fabricator77.highlands.biome.BiomeGenWoodlands;
import com.fabricator77.highlands.biome.BiomeGenWoodsMountains;
...
public class Initializer {
    ...
    public static void constructBlocks() {
        ...
        HighlandsBlocks.acaciaSapling = new BlockHighlandsSapling(1).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_acaciaSapling");
        HighlandsBlocks.beechSapling = new BlockHighlandsSapling(6).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_beechSapling");
        HighlandsBlocks.canopySapling = new BlockHighlandsSapling(4).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_canopySapling");
        HighlandsBlocks.deadSapling = new BlockHighlandsSapling(7).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_deadSapling");
        HighlandsBlocks.greatOakSapling = new BlockHighlandsSapling(5).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_greatOakSapling");
        HighlandsBlocks.firSapling = new BlockHighlandsSapling(0).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_firSapling");
        HighlandsBlocks.poplarSapling = new BlockHighlandsSapling(2).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_poplarSapling");
        HighlandsBlocks.redwoodSapling = new BlockHighlandsSapling(3).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_redwoodSapling");
        HighlandsBlocks.evergreenBushSapling = new BlockHighlandsSapling(8).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_evgBushSapling");
        HighlandsBlocks.deciduousBushSapling = new BlockHighlandsSapling(9).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_decBushSapling");
        HighlandsBlocks.palmSapling = new BlockHighlandsSapling(10).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_palmSapling");
        HighlandsBlocks.ironwoodSapling = new BlockHighlandsSapling(11).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_ironwoodSapling");
        HighlandsBlocks.mangroveSapling = new BlockHighlandsSapling(12).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_mangroveSapling");
        HighlandsBlocks.ashSapling = new BlockHighlandsSapling(13).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_ashSapling");
        HighlandsBlocks.autumnOrangeSapling = new BlockHighlandsSapling(14).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_autumnOrangeSapling");
        HighlandsBlocks.autumnYellowSapling = new BlockHighlandsSapling(15).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_autumnYellowSapling");

        HighlandsBlocks.japaneseMapleSapling = new BlockHighlandsSapling2(1).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_japaneseMapleSapling");

        //Wood
        HighlandsBlocks.acaciaWood = new BlockHighlandsLog(1).setHardness(2.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_acaciaWood");
        HighlandsBlocks.canopyWood = new BlockHighlandsLog(4).setHardness(2.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_canopyWood");
        HighlandsBlocks.firWood = new BlockHighlandsLog(0).setHardness(2.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_firWood");
        HighlandsBlocks.poplarWood = new BlockHighlandsLog(2).setHardness(2.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_poplarWood");
        HighlandsBlocks.redwoodWood = new BlockHighlandsLog(3).setHardness(2.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_redwoodWood");
        HighlandsBlocks.palmWood = new BlockHighlandsLog(10).setHardness(2.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_palmWood");
        HighlandsBlocks.ironWood = new BlockHighlandsLog(11).setHardness(2.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_ironwoodWood");
        HighlandsBlocks.mangroveWood = new BlockHighlandsLog(12).setHardness(2.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_mangroveWood");
        HighlandsBlocks.ashWood = new BlockHighlandsLog(13).setHardness(2.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_ashWood");

        HighlandsBlocks.japaneseMapleWood = new BlockHighlandsLog2(1).setHardness(2.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_japaneseMapleWood");

        //Leaves
        HighlandsBlocks.acaciaLeaves = new BlockHighlandsLeaves(1).setHardness(0.2F)
                .setLightOpacity(1).setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_acaciaLeaves");
        HighlandsBlocks.canopyLeaves = new BlockHighlandsLeaves(4).setHardness(0.2F)
                .setLightOpacity(1).setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_canopyLeaves");
        HighlandsBlocks.firLeaves = new BlockHighlandsLeaves(0).setHardness(0.2F)
                .setLightOpacity(1).setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_firLeaves");
        HighlandsBlocks.poplarLeaves = new BlockHighlandsLeaves(2).setHardness(0.2F)
                .setLightOpacity(1).setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_poplarLeaves");
        HighlandsBlocks.redwoodLeaves = new BlockHighlandsLeaves(3).setHardness(0.2F)
                .setLightOpacity(1).setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_redwoodLeaves");
        HighlandsBlocks.palmLeaves = new BlockHighlandsLeaves(10).setHardness(0.2F)
                .setLightOpacity(1).setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_palmLeaves");
        HighlandsBlocks.ironwoodLeaves = new BlockHighlandsLeaves(11).setHardness(0.2F)
                .setLightOpacity(1).setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_ironwoodLeaves");
        HighlandsBlocks.mangroveLeaves = new BlockHighlandsLeaves(12).setHardness(0.2F)
                .setLightOpacity(1).setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_mangroveLeaves");
        HighlandsBlocks.ashLeaves = new BlockHighlandsLeaves(13).setHardness(0.2F)
                .setLightOpacity(1).setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_ashLeaves");
        HighlandsBlocks.autumnYellowLeaves = new BlockHighlandsLeaves(14).setHardness(0.2F)
                .setLightOpacity(1).setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_autumnYellowLeaves");
        HighlandsBlocks.autumnOrangeLeaves = new BlockHighlandsLeaves(15).setHardness(0.2F)
                .setLightOpacity(1).setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_autumnOrangeLeaves");

        HighlandsBlocks.japaneseMapleLeaves = new BlockHighlandsLeaves2(1).setHardness(0.2F)
                .setLightOpacity(1).setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_japaneseMapleLeaves");

        //Plants
        HighlandsBlocks.blueFlower = new BlockHighlandsSmallPlants(0).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_blueFlower");
        HighlandsBlocks.leafyFern = new BlockHighlandsSmallPlants(1).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_leafyFern");
        HighlandsBlocks.whiteFlower = new BlockHighlandsSmallPlants(2).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_whiteFlower");
        HighlandsBlocks.cattail = new BlockHighlandsSmallPlants(3).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_cattail");
        HighlandsBlocks.lavender = new BlockHighlandsSmallPlants(4).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_lavender");
        HighlandsBlocks.raspberryBush = new BlockHighlandsSmallPlants(5).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_raspberryBush");
        HighlandsBlocks.blueberryBush = new BlockHighlandsSmallPlants(6).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_blueberryBush");
        HighlandsBlocks.thornbush = new BlockHighlandsSmallPlants(7).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_thornbush");
        HighlandsBlocks.cotton = new BlockHighlandsSmallPlants(8).setHardness(0.0F)
                .setStepSound(Block.soundTypeGrass).setUnlocalizedName("hl_cotton");
        ...
        HighlandsBlocks.cocoa2 = new BlockCocoaPlant2().setUnlocalizedName("hl_cocoa");
        ...
        HighlandsBlocks.hlplanks = new BlockHighlandsPlanks().setHardness(2.0F).setResistance(5.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_woodPlanks");
        ...
        HighlandsBlocks.hlplankstairs0 = new BlockHighlandsStairs(HighlandsBlocks.hlplanks, 0).setHardness(2.0F).setResistance(5.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_woodStairs0");
        ...
        HighlandsBlocks.hlplankstairs1 = new BlockHighlandsStairs(HighlandsBlocks.hlplanks, 1).setHardness(2.0F).setResistance(5.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_woodStairs1");
        ...
        HighlandsBlocks.hlplankstairs2 = new BlockHighlandsStairs(HighlandsBlocks.hlplanks, 2).setHardness(2.0F).setResistance(5.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_woodStairs2");
        ...
        HighlandsBlocks.hlplankstairs3 = new BlockHighlandsStairs(HighlandsBlocks.hlplanks, 3).setHardness(2.0F).setResistance(5.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_woodStairs3");
        ...
        HighlandsBlocks.hlplankhalfdouble = new BlockHLPlankSlab(true, HighlandsBlocks.hlplanks).setHardness(2.0F).setResistance(5.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_woodSlabDouble");
        ...
        HighlandsBlocks.hlplankhalf = new BlockHLPlankSlab(false, HighlandsBlocks.hlplanks).setHardness(2.0F).setResistance(5.0F)
                .setStepSound(Block.soundTypeWood).setUnlocalizedName("hl_woodSlab");
    ...
    public static void constructBiomes() {
        ...
        /**
         * Add a Japanese Biome and Cherry Blosom Trees. orientally themed biome
         * Perhaps combine that with lots of water pools and source blocks and
         * high proportion of reeds/bamboo (could be used to produce
         * sticks/planks/medicine). Maybe Fir trees and shrubs + white flowers
         * would give it a humid feel. Grass colour should be a deep green,
         * similar to tropics/flying mountains. For custom ore generation, Coal
         * and iron are common to China/Japan, so these would be best.
         */
        ...
        if (Config.plainsGenerate.getBoolean(true)) {
            HighlandsBiomes.biomesForHighlands.add(BiomeGenBase.plains);
        }
        if (Config.desertGenerate.getBoolean(true)) {
            HighlandsBiomes.biomesForHighlands.add(BiomeGenBase.desert);
        }
        ...
        if (Config.forestGenerate.getBoolean(true)) {
            HighlandsBiomes.biomesForHighlands.add(BiomeGenBase.forest);
        }
        if (Config.swamplandGenerate.getBoolean(true)) {
            HighlandsBiomes.biomesForHighlands.add(BiomeGenBase.swampland);
        }
        if (Config.jungleGenerate.getBoolean(true)) {
            HighlandsBiomes.biomesForHighlands.add(BiomeGenBase.jungle);
        }
        if (Config.icePlainsGenerate.getBoolean(true)) {
            HighlandsBiomes.biomesForHighlands.add(BiomeGenBase.icePlains);
        }
        if (Config.taigaGenerate.getBoolean(true)) {
            HighlandsBiomes.biomesForHighlands.add(BiomeGenBase.taiga);
        }
    }
