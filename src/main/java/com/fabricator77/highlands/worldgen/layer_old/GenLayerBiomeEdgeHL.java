...
public class GenLayerBiomeEdgeHL extends GenLayerBiomeEdge
{
    public GenLayerBiomeEdgeHL(long p_i45475_1_, GenLayer parent)
    {
        super(p_i45475_1_, parent);
        this.parent = parent;
    }
    ...
    {
        if (!suitableForSubBiome(p_151636_6_, p_151636_7_))
        {
            return false;
        }
        else
    ...
    private boolean func_151635_b(int[] p_151635_1_, int[] p_151635_2_, int p_151635_3_, int p_151635_4_, int p_151635_5_, int p_151635_6_, int p_151635_7_, int p_151635_8_)
    {
        ...
        else
        {
            ...
            if (suitableForSubBiome(k1, p_151635_7_) && suitableForSubBiome(l1, p_151635_7_) && suitableForSubBiome(i2, p_151635_7_) && suitableForSubBiome(j2, p_151635_7_))
            {
    ...
    private boolean suitableForSubBiome(int p_151634_1_, int p_151634_2_)
    {
        if (suitableForSubBiome(p_151634_1_, p_151634_2_))
        {
            return true;
        }
