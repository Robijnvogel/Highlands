...
import com.fabricator77.highlands.worldgen.WorldGenJapaneseMapleTree;
import com.fabricator77.highlands.worldgen.WorldGenShrubbery;
...
import com.fabricator77.highlands.worldgen.WorldGenTreeDiamondheart;
...
public class BlockHighlandsSapling2 extends BlockHighlandsSapling implements IPlantable {
    ...
    public void getSubBlocks(Item block, CreativeTabs creativeTabs, List list) {
        ...
        /**
         * for (int i = 0; i < treeNames.length; ++i) { list.add(new
         * ItemStack(block, 1, i)); }
         */
    }
    ...
    public void growTree(World par1World, int i, int j, int k, Random r) {
        ...
        if (treeType == 0) {
            isTreeGrowSuccess = new WorldGenShrubbery(true).generate(par1World, r, i, j, k);
        }
        if (treeType == 1) {
