...
public class BlockHighlandsLeaves2 extends BlockLeavesBase implements IShearable {
    ...
    public Item getItemDropped(int par1, Random par2Random, int par3) {
        if (treeType == 0) {
            return Item.getItemFromBlock(Blocks.sapling); //TODO: add hedge
        }
        if (treeType == 1) {
            return Item.getItemFromBlock(HighlandsBlocks.japaneseMapleSapling);
        }
